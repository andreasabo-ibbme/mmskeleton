...
#SBATCH --job-name=updrs_supcon10_128feats_mlp
...
python mmskl.py configs/recognition/tri/cluster/supcon/UPDRS/train_cluster_10_120_no_norm_128_feats_mlp.yaml
