...
#SBATCH --job-name=updrs_supcon_128feats_mlp
...
python mmskl.py configs/recognition/tri/cluster/supcon/UPDRS/train_cluster_2_120_no_norm_128_feats_mlp_do_0.1.yaml
