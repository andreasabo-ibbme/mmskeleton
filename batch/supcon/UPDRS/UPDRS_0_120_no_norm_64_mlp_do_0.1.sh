...
#SBATCH --job-name=updrs_supcon_64feats_mlp_do_0.1
...
python mmskl.py configs/recognition/tri/cluster/supcon/UPDRS/train_cluster_0_120_no_norm_64_feats_mlp_do_0.1.yaml
