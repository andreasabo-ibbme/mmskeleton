...
#SBATCH --job-name=SAS_11_120_pred_15
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain_coco_simplified_head_ankles_ankle_wrists/SAS/train_cluster_11_120_pred_15,30.yaml
