...
#SBATCH --job-name=UPDRS_2_120_pred_30
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain_coco_simplified_head_ankles_ankle_wrists/UPDRS/train_cluster_2_120_pred_30.yaml
