...
python mmskl.py configs/recognition/tri/cluster/stgcn_coco_simplified_head_ankles_ankle_wrists/UPDRS/v3/train_cluster_SAS_0_120_nonorm_do_0.1_ft_all.yaml
