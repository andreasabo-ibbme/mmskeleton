...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain_coco_simplified_head_ankles_ankle_wrists/UPDRS/v5/temp13/train_cluster_2_120_pred_15_4_joints_do_0.1_ft_all.yaml
