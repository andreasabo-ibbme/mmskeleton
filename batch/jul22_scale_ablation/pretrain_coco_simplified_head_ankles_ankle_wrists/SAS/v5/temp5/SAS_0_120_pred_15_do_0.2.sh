...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain_coco_simplified_head_ankles_ankle_wrists/SAS/v5/temp5/train_cluster_0_120_pred_15_4_joints_do_0.2.yaml
