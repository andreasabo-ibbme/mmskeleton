...
python mmskl.py configs/recognition/tri/cluster/stgcn_coco_simplified_head_ankles_ankle_wrists/UPDRS/v3/train_cluster_10_120_pred_15_4_joints_do_0.1.yaml
