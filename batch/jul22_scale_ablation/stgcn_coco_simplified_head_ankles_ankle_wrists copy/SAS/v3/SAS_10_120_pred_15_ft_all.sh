...
python mmskl.py configs/recognition/tri/cluster/stgcn_coco_simplified_head_ankles_ankle_wrists/SAS/v3/train_cluster_0_120_pred_15_4_joints_ft_all.yaml
