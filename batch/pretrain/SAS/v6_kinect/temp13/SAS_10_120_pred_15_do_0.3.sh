...
#SBATCH --job-name=SAS_openpose_0.3
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/SAS/v6_kinect_2d/temp13/train_cluster_10_120_pred_15_4_joints_do_0.3.yaml
