...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_flip_1_xavier_no_pretrain/UPDRS/detectron/no_gait_features/train_cluster_0_120_pred_15_4_joints_do_0.2.yaml