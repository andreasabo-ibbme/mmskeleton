...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_flip_1/UPDRS/kinect_2d/gait_features/train_cluster_10_120_pred_15_4_joints_do_0.1.yaml