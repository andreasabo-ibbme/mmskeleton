...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_flip_1/UPDRS/alphapose/no_gait_features/train_cluster_0_120_pred_15_4_joints_do_0.4.yaml