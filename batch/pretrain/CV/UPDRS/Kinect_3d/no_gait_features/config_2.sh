...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/CV_configs/UDPRS/kinect_3d/no_gait_features/train_cluster_2_120_pred_15_4_joints_do_0.1.yaml
