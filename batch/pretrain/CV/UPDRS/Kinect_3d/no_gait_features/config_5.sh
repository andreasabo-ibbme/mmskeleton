...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/CV_configs/UPDRS/kinect_3d/no_gait_features/train_cluster_10_120_pred_15_4_joints_do_0.4.yaml