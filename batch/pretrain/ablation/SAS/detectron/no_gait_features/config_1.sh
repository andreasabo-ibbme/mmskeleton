...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs/SAS/detectron/no_gait_features/train_cluster_2_120_pred_15_4_joints_do_0.0.yaml