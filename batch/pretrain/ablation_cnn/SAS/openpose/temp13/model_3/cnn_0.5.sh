...
#SBATCH --job-name=SAS_openpose_cnn
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_cnn/SAS/openpose/temp13/model_3/cnn_0.5.yaml