...
#SBATCH --job-name=SAS_alphapose_cnn
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_cnn/SAS/alphapose/temp13/model_2/cnn_0.1.yaml