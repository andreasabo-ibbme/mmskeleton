...
#SBATCH --job-name=UPDRS_openpose_cnn
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_cnn/UPDRS/openpose/temp13/model_4/cnn_0.4.yaml