...
#SBATCH --job-name=UPDRS_detectron_cnn
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/ablation_configs_cnn/UPDRS/detectron/temp13/model_2/cnn_0.0.yaml