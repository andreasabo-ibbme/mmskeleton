...
#SBATCH --job-name=UPDRS_openpose_0.2
...
python mmskl.py configs/recognition/tri/cluster/pred_pretrain/UPDRS/v6_kinect_2d/temp13/train_cluster_10_120_pred_15_4_joints_do_0.2.yaml
