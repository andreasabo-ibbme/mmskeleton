...
#SBATCH --time=4-24:00            # time (DD-HH:MM)
#SBATCH --job-name=UPDRS_st_0.4
...
python mmskl.py configs/recognition/tri/cluster/self_training/UPDRS/v1/temp13/train_cluster_1_120_pred_15_4_joints_do_0.4.yaml
